...
SEGMENT_VIA={"ride-ewl":(*_EWL_TO_BUGIS,"Bugis","City Hall"),"ride-bugis":("EW2 platform",*_EWL_TO_BUGIS),"ride-dtl":("Promenade","Bayfront"),"ride-bus":("Expressway east","Expressway coast","Expressway city")}
...
def rachel_routes()->tuple[Route,...]:
    return (
      Route("current-ewl","Stay on East-West Line (synthetic)",True,(
        ...
        Segment("ride-ewl",SegmentKind.RIDE,"EW2 platform","Raffles Place",34,3,affected_entities=("EWL",),instructions="Ride the synthetic EWL itinerary to Raffles Place.",mode="rail",distance_km=15.7),
      ),"Bugis",DECISION_DEADLINE,True,"rachel-v1",450,0),
      Route("bugis-dtl","Switch at Bugis to Downtown Line (synthetic)",True,(
        Segment("ride-bugis",SegmentKind.RIDE,"Tampines","Bugis",25,2,instructions="Continue to the synthetic Bugis decision point.",mode="rail",distance_km=12.4),
        ...
        Segment("ride-dtl",SegmentKind.RIDE,"Bugis DTL","Downtown",8,1,instructions="Ride to Downtown.",mode="rail",distance_km=3.0),
